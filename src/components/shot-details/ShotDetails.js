...
class ShotDetails extends Component {
  ...
  componentWillMount() {
    getShotById(this.props.params.id).then(resp => this.setState({ shot: resp.data }));
  }
...
ShotDetails.propTypes = {
  params: React.PropTypes.object.isRequired, // eslint-disable-line react/forbid-prop-types
};
